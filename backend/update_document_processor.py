...
# backend/update_document_processor.py

import os
import shutil
from pathlib import Path

print("🔍 Updating Document Processor to include subdirectories\n")

# Update the document processor to scan subdirectories
document_processor_code = '''import os
...
# Write the updated document processor
with open('app/services/document_processor.py', 'w') as f:
    f.write(document_processor_code)

print("✅ Updated document processor to scan subdirectories")